...
export class TicketService {
  ...
  public tickets: Ticket[] = [
    {id: UuidAdapter.v4(), number: 1, createdAt: new Date(), done: true},
    {id: UuidAdapter.v4(), number: 2, createdAt: new Date(), done: false},
    {id: UuidAdapter.v4(), number: 3, createdAt: new Date(), done: true},
  ...
  public get last4WorkingTickets(): Ticket[] {
  ...
  public createTicket(): Ticket {
    ...
    this.onTicketNumberChanged() // CUando se crea un ticket se actualiza la cola de desk.html
  ...
  private onTicketNumberChanged() {
    this.wssService.sendMessage('ticket-count-change', this.pendingTickets.length)
  }

  private onWorkingOnChanged() {
    this.wssService.sendMessage('on-working-changed', this.last4WorkingTickets );
  }
}